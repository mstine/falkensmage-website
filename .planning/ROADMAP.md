...
- [x] **Phase 6: Offer Pages** (0/3 plans) — `/work/` hub + The Query / The Cast / The Daemon offer pages with Cal.com link-out CTAs; homepage secondary CTA repointed to `/work/`. (completed 2026-07-02)
...
- [x] 06-03-PLAN.md — Homepage secondary CTA repoint to `/work/` + Phase 6 validation script + clean-build check
